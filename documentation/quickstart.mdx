...
- **Sign Up**: Register on [Modem Pay's dashboard](https://modem.gomindz.gm) to access your account and manage payments.
...
```javascript nodejs
import Modem Pay from "modem";

const modem = new Modem Pay();
