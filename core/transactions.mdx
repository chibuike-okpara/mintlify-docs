...
<CodeGroup>
```javascript nodejs
const transaction = await modem.transactions.retrieve(
...
<CodeGroup>
```javascript nodejs
const transactions = await modem.transactions.list();
```
</CodeGroup>
